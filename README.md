...
> **【プロンプト】**
> 以下のReactコードは、Tailwind CSS、lucide-react、recharts、firebaseを使用しています。このコードを使ってCanvas（プレビュー）でアプリを描画してください。必要なパッケージのインポートや初期化は自動で補完してください。
> 
> [ここに Wagtail_app_v2.jsx のコードをペースト]
